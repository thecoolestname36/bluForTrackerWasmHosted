...
public class SignalRHubConnectionService : IAsyncDisposable
{
    ...
    //public delegate Task OnReceiveConnectionId(string connectionId);
    ...
    //public delegate Task OnReceiveInfoMarker(MessageSpike infoMarker);
    //public delegate Task OnReceiveInfoMarkers(List<MessageSpike> infoMarkers);
    //public delegate Task OnRemoveInfoMarker(string key);

    public async Task<HubConnection> Init(
            //OnReceiveConnectionId? onReceiveConnectionId = null,
        ...
        //if(onReceiveConnectionId != null) HubConnection.On<string>(Routing.MarkerHub.Client.ReceiveConnectionId, async (connectionId) => await onReceiveConnectionId(connectionId));
        ...
        //if(onReceiveInfoMarker != null) HubConnection.On<MessageSpike>(Routing.MarkerHub.Client.ReceiveInfoMarker, async (infoMarker) => await onReceiveInfoMarker(infoMarker));
        //if(onReceiveInfoMarkers != null) HubConnection.On<List<MessageSpike>>(Routing.MarkerHub.Client.ReceiveInfoMarkers, async (infoMarkers) => await onReceiveInfoMarkers(infoMarkers));
